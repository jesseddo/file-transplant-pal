  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <header className="border-b border-border bg-card px-6 py-4 flex items-center justify-between">
        <div>
          <h1 className="text-xl font-semibold text-foreground">Scenario Designer</h1>
          <p className="text-sm text-muted-foreground">Create and manage training scenarios</p>
        </div>
      ...
      <main className="max-w-6xl mx-auto px-6 py-8">
        {scenarios.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-24 text-center">
            ...
            <h2 className="text-lg font-medium text-foreground mb-1">No scenarios yet</h2>
